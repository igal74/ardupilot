...
,
    ...
    // @Param: C_PCH_LCK_FBWA
    // @DisplayName: COLUGO pitch lock in FBWA
    // @Description: the pitch of the plane when in FBWA mode
    // @Range: -4500 4500
    // @User: Advanced
    GSCALAR(COLUGO_pitch_lock_FBWA, "C_PCH_LCK_FBWA",
		COLUGO_PITCH_LOCK_FBWA_DEFAULT)
,
...
ParametersG2::ParametersG2(void) :
	ice_control(plane.rpm_sensor, plane.ahrs), soaring_controller(plane.ahrs,
			plane.TECS_controller, plane.aparm) {
...
{ Parameters::k_param_battery_monitoring, 0, AP_PARAM_INT8, "BATT_MONITOR" }, {
	...
	{ Parameters::k_param_curr_amp_per_volt, 0, AP_PARAM_FLOAT,
			"BATT_AMP_PERVOLT" }, { Parameters::k_param_curr_amp_offset, 0,
			AP_PARAM_FLOAT, "BATT_AMP_OFFSET" }, {
			Parameters::k_param_pack_capacity, 0, AP_PARAM_INT32,
			"BATT_CAPACITY" }, { Parameters::k_param_log_bitmask_old, 0,
			AP_PARAM_INT16, "LOG_BITMASK" }, {
			Parameters::k_param_rally_limit_km_old, 0, AP_PARAM_FLOAT,
			"RALLY_LIMIT_KM" }, { Parameters::k_param_rally_total_old, 0,
			AP_PARAM_INT8, "RALLY_TOTAL" }, { Parameters::k_param_serial0_baud,
			0, AP_PARAM_INT16, "SERIAL0_BAUD" },
	...
	{ Parameters::k_param_land_slope_recalc_shallow_threshold, 0,
			...
			Parameters::k_param_land_slope_recalc_steep_threshold_to_abort, 0,
			AP_PARAM_FLOAT, "LAND_ABORT_DEG" }, {
			...
			"LAND_PF_ALT" }, { Parameters::k_param_land_pre_flare_airspeed, 0,
			AP_PARAM_FLOAT, "LAND_PF_ARSPD" }, {
			...
			"LAND_THEN_NEUTRAL" }, {
			Parameters::k_param_land_abort_throttle_enable, 0, AP_PARAM_INT8,
			"LAND_ABORT_THR" }, { Parameters::k_param_land_flap_percent, 0,
			AP_PARAM_INT8, "LAND_FLAP_PERCENT" },
...
AP_Param::ConversionInfo elevon_info = { Parameters::k_param_elevon_output, 0,
